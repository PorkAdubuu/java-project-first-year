...
public class Part2 {
   ...
   public static void main(String[]args) throws IOException { 
      ...
      BufferedReader br = new BufferedReader(new InputStreamReader (System.in));
        ...
        do {
            //Menu 
            System.out.print("Sort By [S] Student Number [G] Grade [V] View [E] Exit: ");
            menu = br.readLine().charAt(0);
               ...
               switch (Character.toUpperCase(menu)) {
                case 'S':
                    ...
                    // Calling the method to Display sorted records
        ...
        } while (Character.toUpperCase(menu) != 'E');
             ...
             // Method to view student records use viewRecords(studentNumbers, studentNames, studentGrades) to pass all the three array 
